...
class OfficeDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (arguments != null){
            val officeDescriptions = listOf("Michael Gary Scott is a fictional character and the protagonist of the NBC sitcom, The Office, portrayed by Steve Carell. Michael serves as the regional manager of the Scranton, Pennsylvania branch of paper company, Dunder Mifflin Inc. ",
